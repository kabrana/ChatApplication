pipeline {
 ...
 post {      
     success {
            slackSend (baseUrl: "https://cs5500-sp2020.slack.com/services/hooks/jenkins-ci/", token: "", channel: "#team-4-SP20", color: '#00FF00', message: "SUCCESSFUL: Job '${env.JOB_NAME}")
            }
   failure {  
         slackSend (baseUrl: "https://cs5500-sp2020.slack.com/services/hooks/jenkins-ci/", token: "", channel: "#team-4-SP20", color: '#FF0000', message: "FAILED: Job '${env.JOB_NAME}")
         }
   }
} //pipeline
